            ...
            <div className="col-12 col-xl-7 ps-xl-4">
              <div className="bg-accent-color-2 p-5 rounded-4 d-flex flex-column gap-5">
                ...
                <form className="form needs-validation" onSubmit={(e) => e.preventDefault()}>
                  <input type="hidden" name="action" value="contact-full" />
                  <div className="row row-cols-1 row-cols-md-2 mb-2">
                    <div className="col">
                      <label htmlFor="fullname" className="form-label">Name</label>
                      <input type="text" name="fullname" id="fullname" className="form-control form-control-lg"
                        placeholder="Full Name" aria-label="Full Name" />
                    </div>
                    <div className="col">
                      <label htmlFor="emailaddress" className="form-label">Email Address</label>
                      <input type="email" name="emailaddress" id="emailaddress"
                        className="form-control form-control-lg" placeholder="Email Address" aria-label="Email Address" />
                    </div>
                  </div>
                  <div className="row mb-2">
                    <div className="col-12 mb-4">
                      <label htmlFor="phone" className="form-label">Phone</label>
                      <input type="number" name="phone" id="phone" className="form-control form-control-lg"
                        placeholder="Telephone" aria-label="Phone" />
                    </div>
                    <div className="col-12 mb-4">
