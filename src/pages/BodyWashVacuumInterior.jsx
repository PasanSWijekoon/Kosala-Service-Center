...
const BodyWashVacuumInterior = () => {
  return (
    <main>
      <SEO title="Body Wash, Vacuum & Interior Cleaning" description="Professional body wash, interior vacuuming, and detailing services." />
      
      {/* Banner */}
      <section className="section position-relative"
        style={{ backgroundImage: "url('images/car-wash-worker-removing-water-from-a-car-body-HKAUHY3.jpg')" }}>
        ...
        <div className="b-container h-100 position-relative z-2">
          <div className="d-flex flex-column justify-content-center align-items-center mx-auto text-center text-white gap-4"
            ...
            <h1 className="heading fw-bold" data-aos="fade-down" data-aos-delay="300" data-aos-duration="1000">BODY WASH & INTERIOR CLEANING</h1>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb" data-aos="fade-down" data-aos-delay="600" data-aos-duration="1000">
                <li className="breadcrumb-item"><Link to="/">Home</Link></li>
                <li className="breadcrumb-item"><Link to="/services">Services</Link></li>
                <li className="breadcrumb-item active" aria-current="page">Body Wash & Interior Cleaning</li>
              </ol>
            </nav>
          </div>
        </div>
          ...
          <div className="row">
              ...
              <div className="d-flex flex-column flex-xl-column flex-lg-row gap-4 mt-4 mt-xl-0">
                <div className="bg-accent-color-2 p-4 rounded-4 d-flex flex-column flex-fill gap-4">
                  ...
                  <div className="d-flex align-items-end">
                    ...
                    <div className="d-flex align-items-center gap-2">
                      ...
                      <h2 className="mt-2 text-white">1,500</h2>
                    </div>
                  </div>
                  <h5 className="mb-0">Estimated Time: 1-2 Hours</h5>
                  <h5 className="mb-0">Available for: Cars, Vans, Lorries, Buses</h5>
                  <a href="https://wa.me/94775775353?text=Hi%20Kosala%20Service%20Center%2C%20I%20would%20like%20to%20book%20the%20Body%20Wash%20%26%20Interior%20Cleaning%20service." className="btn btn-cta-primary w-100 py-3 d-flex align-items-center justify-content-center">
                    BOOK NOW
                ...
                <div className="px-4 pb-4 rounded-4 flex-fill position-relative img-background" style={{ backgroundImage: "url('images/car-detailer-cleaning-modern-vehicle-dashboard-LT5SH8K.jpg')", paddingTop: '150px' }}>
                  ...
                  <div className="d-flex flex-column gap-4 z-1 position-relative">
                    <h3 className="mb-0 text-center">WANT YOUR CAR LOOKING NEW?</h3>
                    <p className="mb-0 text-center">Restore that showroom shine today.</p>
            ...
            <div className="col-12 col-xl-8 ps-xl-4 order-1 order-xl-2">
              <div className="d-flex flex-column gap-4">
                <img src="images/car-wash-worker-removing-water-from-a-car-body-HKAUHY3.jpg" alt="Body Wash Service" className="w-100 rounded-4" style={{ maxHeight: '458px' }} />
                <h3 className="mb-0">Overview</h3>
                <p className="mb-0">
                  Experience a complete transformation with our Body Wash, Vacuum & Interior Cleaning service. We understand that your vehicle is an investment, which is why we use professional-grade cleaning solutions and techniques to restore its showroom appearance. Our process goes beyond a simple wash; we meticulously clean every inch of your vehicle's exterior to remove dirt, grime, and road contaminants, ensuring a spotless finish.
                </p>
                <p className="mb-0">
                  The interior of your car receives equal attention. We perform a deep vacuuming of the cabin, cleaning seats, carpets, and floor mats to remove dust and debris. Our team also specializes in interior foaming and dashboard polishing, leaving your car's inside smelling fresh and looking immaculate. Whether you drive a compact car, a van, or a larger vehicle like a lorry or bus, our dedicated team ensures top-quality results every time.
                </p>
                <h3 className="mb-0">What's Included</h3>
                <p className="mb-0">
                  Our comprehensive cleaning package covers everything your vehicle needs to look its best:
                </p>
                <div className="col-12 col-md-6 col-xl-8 d-flex flex-column flex-md-row w-100 gap-3 gap-md-5">
                  <ul className="p-0 m-0">
                    <li className="list-unstyled mb-3 text-big fw-bold d-flex align-items-center">
                      ...
                      Professional exterior foam wash
                    </li>
                    <li className="list-unstyled mb-3 text-big fw-bold d-flex align-items-center">
                      <i className="bi bi-circle-fill text-primary-color me-4"></i>
                      Underbody cleaning
                    ...
                    <li className="list-unstyled mb-3 text-big fw-bold d-flex align-items-center">
                      <i className="bi bi-circle-fill text-primary-color me-4"></i>
                      Floor mats & boot space cleaning
                    </li>
                  </ul>
                  <ul className="p-0 m-0">
                    <li className="list-unstyled mb-3 text-big fw-bold d-flex align-items-center">
                    ...
                    <li className="list-unstyled mb-3 text-big fw-bold d-flex align-items-center">
                      <i className="bi bi-circle-fill text-primary-color me-4"></i>
                      Seat cleaning & odor removal
                    </li>
                    <li className="list-unstyled mb-3 text-big fw-bold d-flex align-items-center">
                      <i className="bi bi-circle-fill text-primary-color me-4"></i>
                      Wax application included
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-12 col-md-6 col-xl-8 d-flex flex-column flex-md-row align-items-center w-100 gap-3 gap-md-5">
                  <ul className="p-0 m-0">
                    <li className="list-unstyled mb-3 text-big fw-bold d-flex flex-column flex-md-row align-items-center text-center text-md-start">
                      ...
                      Preserves your vehicle's paint and finish
                    </li>
                    <li className="list-unstyled text-big fw-bold d-flex flex-column flex-md-row align-items-center text-center text-md-start">
                      <i className="bi bi-check-circle text-primary-color me-0 me-md-4 fs-1"></i>
                      Creates a healthier, dust-free interior environment
                    </li>
                  </ul>
                  <ul className="p-0 m-0">
                    <li className="list-unstyled mb-3 text-big fw-bold d-flex flex-column flex-md-row align-items-center text-center text-md-start">
                      <i className="bi bi-check-circle text-primary-color me-0 me-md-4 fs-1"></i>
                      Enhances resale value through regular maintenance
                    </li>
                    <li className="list-unstyled text-big fw-bold d-flex flex-column flex-md-row align-items-center text-center text-md-start">
                      <i className="bi bi-check-circle text-primary-color me-0 me-md-4 fs-1"></i>
                      Uses safe, professional-grade cleaning products
                    </li>
                  </ul>
                </div>
                ...
                <div className="d-flex flex-column gap-3 bg-primary-color rounded-4 p-4 mt-5">
                  ...
                  <p className="text-big mb-0">“The body wash and interior cleaning service completely revitalized my car. It feels like driving a brand new vehicle again!”</p>
                  <div className="d-flex flex-column">
                    <p className="text-big fw-bold mb-0">Kasun Perera</p>
                    <p className="mb-0">Toyota Aqua Owner</p>
                  </div>
                </div>
              </div>
            </div>
...
export default BodyWashVacuumInterior;
